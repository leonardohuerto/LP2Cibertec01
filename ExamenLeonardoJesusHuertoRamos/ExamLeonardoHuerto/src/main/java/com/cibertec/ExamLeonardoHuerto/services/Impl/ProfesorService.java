...
import com.cibertec.ExamLeonardoHuerto.repository.IProfesorRepository;
...
public class ProfesorService implements IProfesorService {
    ...
    public Integer update(Integer id, Profesor profesor) {
        ...
        if (existingProfesor.isPresent()) {
            ...
            profesorToUpdate.setGenero(profesor.getGenero());
            _profesorRepository.save(profesorToUpdate);
            return 1; // Successfully updated
        } else {
            return 0; // Profesor not found
        }
    }
    ...
    public Integer delete(Integer id) {
        ...
        if (optionalProfesor.isPresent()) {
            ...
            return 0; // Indica que el profesor no fue encontrado
        }
    }
}
